...
int main()                                    // Main function
{
  ...
  print("This board will recive messages via wireless.\n");
  ...
  //clear the sender's screan and tell them it is ok to start typing 
...
void init_radio(fdserial *radio)
{
  const char channel = 'B';            // 0x0 100x1A, must match your partner 
